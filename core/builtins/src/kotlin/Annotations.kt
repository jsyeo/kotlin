...
public annotation(retention = SOURCE, mustBeDocumented = true) class suppress(vararg val names: String)
 ...
 */
target(FUNCTION)
public annotation(retention = SOURCE, mustBeDocumented = true) class tailRecursive
