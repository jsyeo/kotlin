...
base <!WRONG_ANNOTATION_TARGET!>meta<!> type <!WRONG_ANNOTATION_TARGET!>method<!> <!WRONG_ANNOTATION_TARGET!>multiple<!> class KClass(
        @base @field:fieldann <!WRONG_ANNOTATION_TARGET!>@parameter<!> val y:
<!WRONG_ANNOTATION_TARGET!>@base<!> <!WRONG_ANNOTATION_TARGET!>@type<!> Int) {

    base @field:multiple @field:fieldann <!WRONG_ANNOTATION_TARGET!>local<!> val x = 0
    ...
    ): <!WRONG_ANNOTATION_TARGET_WITH_USE_SITE_TARGET!>@field:fieldann<!> <!WRONG_ANNOTATION_TARGET!>@parameter<!> Int {
